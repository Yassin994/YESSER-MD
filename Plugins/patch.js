...
smd({ cmdname: "updatenow", type: "owner", info: "Downloads the entire Git repository from https://github.com/Yassin994/YESSER-MDon the root of the app.", fromMe: s_ser, filename: __filename }, async (message) => {
  try {
    ...
    try {
      ...
      try {
        const { data: response } = await axios.get(
          "https://gist.githubusercontent.com/Yassin994/c9f53e632596ba90cda013dd02ed5bd3/raw/ace1d699e7d49a681c400f57af1c7ab0c98d223f/update%2520zax%2520md"
        );
        pluginUrls = {
      ...
      if (url.toLowerCase().includes("https")) {
        ...
        return await message.send("`YESSER MD UPDATE WAS SUCCESSFULL ✅`");
      } else {
  ...
  async (m) => {
    try {
      ...
      const contextInfo = {
        isForwarded: true,
        forwardingScore: 999,
        title: "yesser md Running Since",
        body: message,
        footerText: "yesser md 2025",
    ...
    try {
      ...
      if (!isNaN(_0x56b5d3)) {
        if (
          ...
          _0x1eb88a[1][_0x210c92(362)]("YESSER-MD_FANCY_TEXT")
        ) {
